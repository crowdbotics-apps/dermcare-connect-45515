"""
Django settings for dermcare_connect_45515 project.
...
ROOT_URLCONF = 'dermcare_connect_45515.urls'
...
WSGI_APPLICATION = 'dermcare_connect_45515.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dermcare_connect_45515 API",
    "DESCRIPTION": "API documentation for dermcare_connect_45515 App",
    "VERSION": "v1",
}
